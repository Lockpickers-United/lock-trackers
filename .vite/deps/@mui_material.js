...
import {
  Box_default,
  boxClasses_default
} from "./chunk-OZZDETLT.js";
import "./chunk-B7L4QIIB.js";
import {
  Badge_default,
  badgeClasses_default,
  getBadgeUtilityClass
} from "./chunk-T35M73DH.js";
...
} from "./chunk-WIZG4M65.js";
import {
  SwipeableDrawer_default
} from "./chunk-DF2RRHK4.js";
import {
  Drawer_default,
...
import {
  Slide_default
} from "./chunk-RUIQW2O7.js";
import {
  Avatar_default,
  avatarClasses_default,
  getAvatarUtilityClass
} from "./chunk-DVHNDPK2.js";
import {
  Tooltip_default,
...
} from "./chunk-AJJ3BXT7.js";
import {
  Chip_default,
  chipClasses_default,
  getChipUtilityClass
} from "./chunk-W6CDBK7U.js";
import {
  InputAdornment_default,
  getInputAdornmentUtilityClass,
  inputAdornmentClasses_default
} from "./chunk-2BJ2QUBZ.js";
import {
...
} from "./chunk-5E4FCHIW.js";
import {
  DialogContext_default,
  Dialog_default,
  dialogClasses_default,
  getDialogUtilityClass
} from "./chunk-ZUBZWKAT.js";
import {
...
} from "./chunk-SKPBYNCF.js";
import {
  MenuList_default,
  Menu_default,
  getMenuUtilityClass,
  menuClasses_default
} from "./chunk-QVDKKLHS.js";
import {
  PopoverPaper,
  PopoverRoot,
  Popover_default,
...
} from "./chunk-D6FP3J4Z.js";
import {
  Popper_default
} from "./chunk-RNHKPUKU.js";
import {
  Grow_default
...
} from "./chunk-WUO6YF52.js";
import {
  init_unsupportedProp,
  unsupportedProp_default
} from "./chunk-UA5A6LOU.js";
import {
  debounce_default,
...
} from "./chunk-4Q2H2G2E.js";
import {
  init_useId,
  useId_default
} from "./chunk-F4Y762LZ.js";
import {
  init_useControlled,
...
var AvatarGroup = React10.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsxs)(AvatarGroupRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [extraAvatars ? (0, import_jsx_runtime12.jsx)(AvatarGroupAvatar, _extends({
      ownerState,
      variant
...
var BottomNavigation = React11.forwardRef(function BottomNavigation2(inProps, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(BottomNavigationRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
var BottomNavigationAction = React12.forwardRef(function BottomNavigationAction2(inProps, ref) {
  ...
  return (0, import_jsx_runtime16.jsxs)(BottomNavigationActionRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    focusRipple: true,
...
function BreadcrumbCollapsed(props) {
  ...
  return (0, import_jsx_runtime18.jsx)("li", {
    children: (0, import_jsx_runtime18.jsx)(BreadcrumbCollapsedButton, _extends({
      focusRipple: true
    }, otherProps, {
      ownerState,
      children: (0, import_jsx_runtime18.jsx)(BreadcrumbCollapsedIcon, _extends({
...
var Breadcrumbs = React15.forwardRef(function Breadcrumbs2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(BreadcrumbsRoot, _extends({
    ref,
    component,
...
var ButtonGroup = React16.forwardRef(function ButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(ButtonGroupRoot, _extends({
    as: component,
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
...
var _excluded11 = ["children", "className", "focusVisibleClassName"];
...
var CardActionArea = React17.forwardRef(function CardActionArea2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsxs)(CardActionAreaRoot, _extends({
    className: clsx_default(classes.root, className),
...
var _excluded12 = ["children", "className", "component", "image", "src", "style"];
...
var _excluded13 = ["className", "color", "disableShrink", "size", "style", "thickness", "value", "variant"];
var _ = (t) => t;
var _t;
var _t2;
var _t3;
...
var _excluded16 = ["className", "columns", "columnSpacing", "component", "container", "direction", "item", "rowSpacing", "spacing", "wrap", "zeroMinWidth"];
...
var Grid = React23.forwardRef(function Grid2(inProps, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(GridContext_default.Provider, {
    value: columns,
    children: (0, import_jsx_runtime27.jsx)(GridRoot, _extends({
      ownerState,
      className: clsx_default(classes.root, className),
      as: component,
      ref
...
var _excluded17 = ["initialWidth", "width"];
...
var withWidth = (options = {}) => (Component) => {
  ...
  function WithWidth(props) {
    ...
    const _getThemeProps = getThemeProps({
      ...
      initialWidth,
      width
    } = _getThemeProps, other = _objectWithoutPropertiesLoose(_getThemeProps, _excluded17);
...
function HiddenJs(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React25.Fragment, {
    children
  });
}
...
var _excluded18 = ["children", "className", "only"];
...
var _excluded19 = ["implementation", "lgDown", "lgUp", "mdDown", "mdUp", "smDown", "smUp", "xlDown", "xlUp", "xsDown", "xsUp"];
...
var _excluded20 = ["baseClassName", "className", "color", "component", "fontSize"];
...
var Link = React29.forwardRef(function Link2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(LinkRoot, _extends({
    color,
    className: clsx_default(classes.root, className),
...
true ? Link.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types24.default.any,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default 'always'
   */
  underline: import_prop_types24.default.oneOf(["always", "hover", "none"]),
  /**
...
var _excluded23 = ["activeStep", "backButton", "className", "LinearProgressProps", "nextButton", "position", "steps", "variant"];
...
var MobileStepper = React30.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime34.jsxs)(MobileStepperRoot, _extends({
    square: true,
    elevation: 0,
    className: clsx_default(classes.root, className),
    ref,
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime34.jsxs)(React30.Fragment, {
      children: [activeStep + 1, " / ", steps]
    }), variant === "dots" && (0, import_jsx_runtime35.jsx)(MobileStepperDots, {
      ownerState,
      className: classes.dots,
      children: [...new Array(steps)].map((_2, index) => (0, import_jsx_runtime35.jsx)(MobileStepperDot, {
        className: clsx_default(classes.dot, index === activeStep && classes.dotActive),
        ownerState,
        dotActive: index === activeStep
      }, index))
    }), variant === "progress" && (0, import_jsx_runtime35.jsx)(MobileStepperProgress, _extends({
      ownerState,
...
true ? MobileStepper.propTypes = {
   ...
   */
  backButton: import_prop_types25.default.node,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  LinearProgressProps: import_prop_types25.default.object,
  /**
   * A next button element. For instance, it can be a `Button` or an `IconButton`.
   */
  nextButton: import_prop_types25.default.node,
  /**
   * Set the positioning type.
   * @default 'bottom'
   */
  position: import_prop_types25.default.oneOf(["bottom", "static", "top"]),
  /**
   * The total steps.
   */
   ...
   * @default 'dots'
   */
  variant: import_prop_types25.default.oneOf(["dots", "progress", "text"])
} : void 0;
...
var _excluded24 = ["className", "children", "classes", "IconComponent", "input", "inputProps", "variant"];
...
var defaultInput = (0, import_jsx_runtime36.jsx)(Input_default, {});
var NativeSelect = React31.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  const otherClasses = _objectWithoutPropertiesLoose(classesProp, _excluded25);
  return (0, import_jsx_runtime36.jsx)(React31.Fragment, {
    children: React31.cloneElement(input, _extends({
...
var LastPage_default = createSvgIcon((0, import_jsx_runtime38.jsx)("path", {
...
var PaginationItem = React36.forwardRef(function PaginationItem2(inProps, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime41.jsx)(PaginationItemEllipsis, {
    ...
    className: clsx_default(classes.root, className),
    children: "…"
  }) : (0, import_jsx_runtime42.jsxs)(PaginationItemPage, _extends({
    ref,
    ownerState,
    component,
    disabled,
    ...
    children: [type === "page" && page, Icon3 ? (0, import_jsx_runtime41.jsx)(PaginationItemPageIcon, {
      as: Icon3,
      ownerState,
      className: classes.icon
    }) : null]
...
var Pagination = React37.forwardRef(function Pagination2(inProps, ref) {
  ...
  const {
    ...
    hideNextButton = false,
    hidePrevButton = false,
    renderItem = (item) => (0, import_jsx_runtime43.jsx)(PaginationItem_default, _extends({}, item)),
    shape = "circular",
    showFirstButton = false,
    showLastButton = false,
    siblingCount = 1,
  ...
  return (0, import_jsx_runtime43.jsx)(PaginationRoot, _extends({
    "aria-label": "pagination navigation",
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other, {
    children: (0, import_jsx_runtime43.jsx)(PaginationUl, {
      className: classes.ul,
      ownerState,
      children: items.map((item, index) => (0, import_jsx_runtime43.jsx)("li", {
...
var RadioButtonUnchecked_default = createSvgIcon((0, import_jsx_runtime44.jsx)("path", {
...
var RadioButtonChecked_default = createSvgIcon((0, import_jsx_runtime45.jsx)("path", {
...
function RadioButtonIcon(props) {
  ...
  return (0, import_jsx_runtime47.jsxs)(RadioButtonIconRoot, {
    ...
    ownerState,
    children: [(0, import_jsx_runtime46.jsx)(RadioButtonIconBackground, {
      fontSize,
      className: classes.background,
      ownerState
    }), (0, import_jsx_runtime46.jsx)(RadioButtonIconDot, {
      fontSize,
...
true ? RadioButtonIcon.propTypes = {
   ...
   */
  fontSize: import_prop_types29.default.oneOf(["small", "medium"])
} : void 0;
...
var defaultCheckedIcon = (0, import_jsx_runtime48.jsx)(RadioButtonIcon_default, {
  checked: true
});
var defaultIcon = (0, import_jsx_runtime48.jsx)(RadioButtonIcon_default, {});
var Radio = React43.forwardRef(function Radio2(inProps, ref) {
  ...
  return (0, import_jsx_runtime48.jsx)(RadioRoot, _extends({
    type: "radio",
...
var _excluded30 = ["actions", "children", "defaultValue", "name", "onChange", "value"];
var RadioGroup = React44.forwardRef(function RadioGroup2(props, ref) {
  ...
  return (0, import_jsx_runtime49.jsx)(RadioGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime49.jsx)(FormGroup_default, _extends({
      role: "radiogroup",
      ref: handleRef
    }, other, {
      children
...
var Star_default = createSvgIcon((0, import_jsx_runtime50.jsx)("path", {
...
var StarBorder_default = createSvgIcon((0, import_jsx_runtime51.jsx)("path", {
...
function IconContainer(props) {
  const other = _objectWithoutPropertiesLoose(props, _excluded31);
  return (0, import_jsx_runtime52.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime52.jsx)(RatingIcon, {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime52.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime53.jsxs)(React47.Fragment, {
    children: [(0, import_jsx_runtime53.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
        emptyValueFocused: void 0
      }),
      htmlFor: id
    }, labelProps, {
      children: [container, (0, import_jsx_runtime52.jsx)("span", {
...
true ? RatingItem.propTypes = {
  ...
  disabled: import_prop_types32.default.bool.isRequired,
  emptyIcon: import_prop_types32.default.node,
  focus: import_prop_types32.default.number.isRequired,
  getLabelText: import_prop_types32.default.func.isRequired,
  highlightSelectedOnly: import_prop_types32.default.bool.isRequired,
  hover: import_prop_types32.default.number.isRequired,
  icon: import_prop_types32.default.node,
  IconContainerComponent: import_prop_types32.default.elementType.isRequired,
  isActive: import_prop_types32.default.bool.isRequired,
  itemValue: import_prop_types32.default.number.isRequired,
  labelProps: import_prop_types32.default.object,
  name: import_prop_types32.default.string,
  onBlur: import_prop_types32.default.func.isRequired,
  onChange: import_prop_types32.default.func.isRequired,
  onClick: import_prop_types32.default.func.isRequired,
  onFocus: import_prop_types32.default.func.isRequired,
  ownerState: import_prop_types32.default.object.isRequired,
  ratingValue: import_prop_types32.default.number,
  ratingValueRounded: import_prop_types32.default.number,
  readOnly: import_prop_types32.default.bool.isRequired
} : void 0;
var defaultIcon2 = (0, import_jsx_runtime52.jsx)(Star_default, {
  fontSize: "inherit"
});
var defaultEmptyIcon = (0, import_jsx_runtime52.jsx)(StarBorder_default, {
  fontSize: "inherit"
});
...
var Rating = React47.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime53.jsxs)(RatingRoot, _extends({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_2, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime52.jsx)(RatingDecimal, {
          className: clsx_default(classes.decimal, isActive && classes.iconActive),
          ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return (0, import_jsx_runtime52.jsx)(RatingItem, _extends({}, ratingItemProps, {
    ...
    }), !readOnly && !disabled && (0, import_jsx_runtime53.jsxs)(RatingLabel, {
      className: clsx_default(classes.label, classes.labelEmptyValue),
      ownerState,
      children: [(0, import_jsx_runtime52.jsx)("input", {
        className: classes.visuallyHidden,
        value: "",
        id: `${name}-empty`,
        type: "radio",
...
true ? Rating.propTypes = {
   ...
   * @default null
   */
  defaultValue: import_prop_types32.default.number,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * @default 'Empty'
   */
  emptyLabelText: import_prop_types32.default.node,
  /**
   ...
   * }
   */
  getLabelText: import_prop_types32.default.func,
  /**
   * If `true`, only the selected icon will be highlighted.
   * @default false
   */
  highlightSelectedOnly: import_prop_types32.default.bool,
  /**
   * The icon to display.
   ...
   * }
   */
  IconContainerComponent: import_prop_types32.default.elementType,
  /**
   * Maximum rating.
   * @default 5
   */
   ...
   */
  onChangeActive: import_prop_types32.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  onMouseMove: import_prop_types32.default.func,
  /**
   * The minimum increment value change allowed.
   * @default 1
   */
  precision: chainPropTypes(import_prop_types32.default.number, (props) => {
...
var ScopedCssBaseline = React48.forwardRef(function ScopedCssBaseline2(inProps, ref) {
  ...
  return (0, import_jsx_runtime54.jsx)(ScopedCssBaselineRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
function SliderValueLabel(props) {
  ...
  return React49.cloneElement(children, {
    ...
    children: [children.props.children, (0, import_jsx_runtime55.jsx)("span", {
...
var Slider = React50.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime58.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime57.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime57.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime58.jsxs)(React50.Fragment, {
        children: [(0, import_jsx_runtime57.jsx)(MarkSlot, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime57.jsx)(MarkLabelSlot, _extends({
          "aria-hidden": true,
          "data-index": index
      ...
      return (
        ...
        (0, import_jsx_runtime57.jsx)(ValueLabelComponent, _extends({}, !isHostComponent(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          children: (0, import_jsx_runtime57.jsx)(ThumbSlot, _extends({
            "data-index": index
          }, thumbProps, {
            ...
            children: (0, import_jsx_runtime57.jsx)(InputSlot, _extends({
              "data-index": index,
...
var SnackbarContent = React51.forwardRef(function SnackbarContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime60.jsxs)(SnackbarContentRoot, _extends({
    role,
    square: true,
    elevation: 6,
    className: clsx_default(classes.root, className),
...
true ? SnackbarContent.propTypes = {
   ...
   */
  message: import_prop_types36.default.node,
  /**
   * The ARIA role attribute of the element.
   * @default 'alert'
   */
...
var Snackbar = React52.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime61.jsx)(ClickAwayListener, _extends({
    onClickAway
  }, ClickAwayListenerProps, {
    children: (0, import_jsx_runtime61.jsx)(SnackbarRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime61.jsx)(TransitionComponent, _extends({
        ...
        children: children || (0, import_jsx_runtime61.jsx)(SnackbarContent_default, _extends({
          message,
          action
        }, ContentProps))
      }))
...
true ? Snackbar.propTypes = {
  ...
  anchorOrigin: import_prop_types37.default.shape({
    horizontal: import_prop_types37.default.oneOf(["center", "left", "right"]).isRequired,
   ...
   */
  ClickAwayListenerProps: import_prop_types37.default.object,
  /**
   * Props applied to the [`SnackbarContent`](/material-ui/api/snackbar-content/) element.
   */
  ContentProps: import_prop_types37.default.object,
  /**
...
var SpeedDial = React54.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    transitionDuration = defaultTransitionDuration,
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded38), other = _objectWithoutPropertiesLoose(props, _excluded212);
  ...
  return (0, import_jsx_runtime64.jsxs)(SpeedDialRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    ...
    children: [(0, import_jsx_runtime63.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime63.jsx)(SpeedDialFab, _extends({
        color: "primary",
        "aria-label": ariaLabel,
        "aria-haspopup": "true",
        "aria-expanded": open,
...
true ? SpeedDial.propTypes = {
   ...
   */
  ariaLabel: import_prop_types39.default.string.isRequired,
  /**
   ...
   * @default {}
   */
  FabProps: import_prop_types39.default.object,
  /**
...
var _excluded40 = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var SpeedDialAction = React55.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React55.useState(tooltipOpenProp);
...
true ? SpeedDialAction.propTypes = {
   ...
   * @default 0
   */
  delay: import_prop_types40.default.number,
  /**
   ...
   */
  TooltipClasses: import_prop_types40.default.object,
  /**
   * Make the tooltip always visible when the SpeedDial is open.
   * @default false
   */
  tooltipOpen: import_prop_types40.default.bool,
  /**
   * Placement of the tooltip.
   * @default 'left'
   */
  tooltipPlacement: import_prop_types40.default.oneOf(["bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
   * Label to display in the tooltip.
   */
  tooltipTitle: import_prop_types40.default.node
} : void 0;
...
var _excluded41 = ["className", "icon", "open", "openIcon"];
...
var SpeedDialIcon = React57.forwardRef(function SpeedDialIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialIcon"
  });
  ...
  function formatIcon(icon, newClassName) {
    if (React57.isValidElement(icon)) {
      return React57.cloneElement(icon, {
...
var StepperContext = React58.createContext({});
if (true) {
  StepperContext.displayName = "StepperContext";
}
function useStepperContext() {
  return React58.useContext(StepperContext);
}
var StepperContext_default = StepperContext;

// node_modules/@mui/material/Step/StepContext.js
var React59 = __toESM(require_react());
var StepContext = React59.createContext({});
if (true) {
  StepContext.displayName = "StepContext";
}
function useStepContext() {
  return React59.useContext(StepContext);
}
...
var Step = React60.forwardRef(function Step2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiStep"
  });
  ...
  return (0, import_jsx_runtime71.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime70.jsxs)(React60.Fragment, {
...
true ? Step.propTypes = {
   ...
   */
  completed: import_prop_types42.default.bool,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  expanded: import_prop_types42.default.bool,
  /**
   ...
   * The prop defaults to the value inherited from the parent Stepper component.
   */
  last: import_prop_types42.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
true ? StepLabel.propTypes = {
  ...
  componentsProps: import_prop_types44.default.shape({
    label: import_prop_types44.default.object
  }),
  /**
   * If `true`, the step is marked as failed.
   * @default false
   ...
   */
  StepIconComponent: import_prop_types44.default.elementType,
  /**
   * Props applied to the [`StepIcon`](/material-ui/api/step-icon/) element.
   */
  StepIconProps: import_prop_types44.default.object,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var StepButton = React65.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React65.cloneElement(children, childProps) : (0, import_jsx_runtime78.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var Stepper = React68.forwardRef(function Stepper2(inProps, ref) {
  ...
  const steps = childrenArray.map((step, index) => {
    return React68.cloneElement(step, _extends({
      index,
...
true ? Stepper.propTypes = {
   ...
   * @default false
   */
  alternativeLabel: import_prop_types48.default.bool,
  /**
   ...
   */
  connector: import_prop_types48.default.element,
  /**
   * If set the `Stepper` will not assist in controlling steps for linear flow.
   * @default false
   */
  nonLinear: import_prop_types48.default.bool,
  /**
   * The component orientation (layout flow direction).
   * @default 'horizontal'
   */
...
var Switch = React69.forwardRef(function Switch2(inProps, ref) {
  ...
  const icon = (0, import_jsx_runtime82.jsx)(SwitchThumb, {
    className: classes.thumb,
    ownerState
  });
  return (0, import_jsx_runtime83.jsxs)(SwitchRoot, {
    className: clsx_default(classes.root, className),
    sx,
    ownerState,
    children: [(0, import_jsx_runtime82.jsx)(SwitchSwitchBase, _extends({
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    })), (0, import_jsx_runtime82.jsx)(SwitchTrack, {
      className: classes.track,
      ownerState
    })]
  });
...
var _excluded50 = ["className", "component", "padding", "size", "stickyHeader"];
...
var Table = React71.forwardRef(function Table2(inProps, ref) {
  ...
  return (0, import_jsx_runtime84.jsx)(TableContext_default.Provider, {
    value: table,
    children: (0, import_jsx_runtime84.jsx)(TableRoot, _extends({
      as: component,
...
true ? Table.propTypes = {
   ...
   * @default false
   */
  stickyHeader: import_prop_types50.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var Tablelvl2Context = React72.createContext();
if (true) {
...
var TableBody = React73.forwardRef(function TableBody2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableBody"
  });
  ...
  return (0, import_jsx_runtime85.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl2,
    children: (0, import_jsx_runtime85.jsx)(TableBodyRoot, _extends({
      className: clsx_default(classes.root, className),
      as: component,
      ref,
...
var _excluded52 = ["align", "className", "component", "padding", "scope", "size", "sortDirection", "variant"];
...
var TableCell = React74.forwardRef(function TableCell2(inProps, ref) {
  ...
  const tablelvl24 = React74.useContext(Tablelvl2Context_default);
  ...
  return (0, import_jsx_runtime86.jsx)(TableCellRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    "aria-sort": ariaSort,
...
var TableContainer = React75.forwardRef(function TableContainer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime87.jsx)(TableContainerRoot, _extends({
    ref,
    as: component,
    className: clsx_default(classes.root, className),
    ownerState
...
var TableFooter = React76.forwardRef(function TableFooter2(inProps, ref) {
  ...
  return (0, import_jsx_runtime88.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl22,
    children: (0, import_jsx_runtime88.jsx)(TableFooterRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
...
var TableHead = React77.forwardRef(function TableHead2(inProps, ref) {
  ...
  return (0, import_jsx_runtime89.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl23,
    children: (0, import_jsx_runtime89.jsx)(TableHeadRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
...
var TablePaginationActions = React78.forwardRef(function TablePaginationActions2(props, ref) {
  ...
  return (0, import_jsx_runtime91.jsxs)("div", _extends({
    ...
    children: [showFirstButton && (0, import_jsx_runtime90.jsx)(FirstButtonSlot, _extends({
      onClick: handleFirstPageButtonClick,
      disabled: disabled || page === 0,
      "aria-label": getItemAriaLabel("first", page),
      title: getItemAriaLabel("first", page)
    }, firstButtonSlotProps, {
      children: theme.direction === "rtl" ? (0, import_jsx_runtime90.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon)) : (0, import_jsx_runtime90.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon))
    })), (0, import_jsx_runtime90.jsx)(PreviousButtonSlot, _extends({
      ...
      children: theme.direction === "rtl" ? (0, import_jsx_runtime90.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon)) : (0, import_jsx_runtime90.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon))
    })), (0, import_jsx_runtime90.jsx)(NextButtonSlot, _extends({
      ...
      children: theme.direction === "rtl" ? (0, import_jsx_runtime90.jsx)(PreviousButtonIcon, _extends({}, slotProps.previousButtonIcon)) : (0, import_jsx_runtime90.jsx)(NextButtonIcon, _extends({}, slotProps.nextButtonIcon))
    })), showLastButton && (0, import_jsx_runtime90.jsx)(LastButtonSlot, _extends({
      onClick: handleLastPageButtonClick,
      disabled: disabled || page >= Math.ceil(count / rowsPerPage) - 1,
      "aria-label": getItemAriaLabel("last", page),
      title: getItemAriaLabel("last", page)
    }, lastButtonSlotProps, {
      children: theme.direction === "rtl" ? (0, import_jsx_runtime90.jsx)(FirstButtonIcon, _extends({}, slotProps.firstButtonIcon)) : (0, import_jsx_runtime90.jsx)(LastButtonIcon, _extends({}, slotProps.lastButtonIcon))
    }))]
  }));
});
...
var TablePagination = React79.forwardRef(function TablePagination2(inProps, ref) {
  ...
  return (0, import_jsx_runtime92.jsx)(TablePaginationRoot, _extends({
    colSpan,
    ref,
    as: component,
    ownerState,
    ...
    children: (0, import_jsx_runtime93.jsxs)(TablePaginationToolbar, {
      className: classes.toolbar,
      children: [(0, import_jsx_runtime92.jsx)(TablePaginationSpacer, {
        className: classes.spacer
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime92.jsx)(TablePaginationSelectLabel, {
        className: classes.selectLabel,
        id: labelId,
        children: labelRowsPerPage
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime92.jsx)(TablePaginationSelect, _extends({
        variant: "standard"
      }, !selectProps.variant && {
      ...
      })), (0, import_jsx_runtime92.jsx)(TablePaginationDisplayedRows, {
...
var _excluded58 = ["className", "component", "hover", "selected"];
...
var TableRow = React80.forwardRef(function TableRow2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableRow"
  });
...
var _excluded59 = ["active", "children", "className", "direction", "hideSortIcon", "IconComponent"];
...
var TableSortLabel = React82.forwardRef(function TableSortLabel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableSortLabel"
  });
...
var ToggleButton = React85.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React85.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded60);
...
var _excluded61 = ["children", "className", "color", "disabled", "exclusive", "fullWidth", "onChange", "orientation", "size", "value"];
...
var _excluded62 = ["getTrigger", "target"];
...
function useScrollTrigger(options = {}) {
  ...
  } = options, other = _objectWithoutPropertiesLoose(options, _excluded62);
  const store = React87.useRef();
  const [trigger, setTrigger] = React87.useState(() => getTrigger(store, other));
  React87.useEffect(() => {
    const handleScroll = () => {
