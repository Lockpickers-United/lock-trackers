...
const DBContextGlobal = React.createContext({})

export function DBProviderGlobal({children}) {
...
// VALUE & PROVIDER //
    ...
    return (
        <DBContextGlobal.Provider value={value}>
            {children}
        </DBContextGlobal.Provider>
    )
}

export default DBContextGlobal
